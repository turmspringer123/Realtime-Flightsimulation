import { LOG_LEVEL, DeepstreamPlugin, DeepstreamLogger, DeepstreamConfig, DeepstreamServices, NamespacedLogger } from '@deepstream/types';
export declare class PinoLogger extends DeepstreamPlugin implements DeepstreamLogger {
    private services;
    description: string;
    private logger;
    constructor(pluginOptions: {}, services: DeepstreamServices, config: DeepstreamConfig);
    /**
