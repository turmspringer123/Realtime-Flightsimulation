...
const vertical_cluster_node_1 = require("../services/cluster-node/vertical-cluster-node");
...
function handleClusterNode(config, services) {
    let ClusterNodeClass = defaultPlugins.get('clusterNode');
    if (config.clusterNode.name === 'vertical') {
        ClusterNodeClass = vertical_cluster_node_1.VerticalClusterNode;
    }
