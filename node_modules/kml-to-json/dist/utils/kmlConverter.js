 ...
 */
function getJsonData(kmlObject) {
    let current = '';
    Object.entries(kmlObject)
        ...
        if (tag[1].data) {
            ...
            const idIndex = name.lastIndexOf('--') !== -1 ? name.lastIndexOf('--') : name.length;
 ...
 */
function convertToKML(json) {
    if (typeof json !== 'object' && typeof json !== 'string') {
        throw new Error('Invalid argument type! It is expected to receive an object or string.');
    }
...
exports.convertToKML = convertToKML;
//# sourceMappingURL=kmlConverter.js.map